          ...
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff; border-radius:5px 5px 0 0;">
              <tr>
                ...
                <tr>
                    ...
                    <tr>
                    <td width="28">&nbsp;</td>
                      <td align="center" valign="middle"><a href="#"><img src="{{ asset('img/logo_light_colorfull.png')}}" width="205" height="54" alt="Wohoo"></a></td>
                    </tr>
                    <tr>
                    </tr>
                  </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
  ...
  <tr>
    <td>
    	<table width="100%" bgcolor="#ffffff"  border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="border-bottom:1px solid #e5e5e5;">
 <tr>
 <td width="46">&nbsp;</td>
 	<td>
  ...
  <tr>
  	<td class="heading" style="font:700 30px 'Montserrat', Helvetica, Arial, sans-serif; color:#f27b69; text-transform:uppercase;">thank you for your order</td>
  </tr>
  <tr>
...
@endforeach  
   {{-- <tr>
    <td><img src="images/bag02.jpg" width="190" height="193" alt="Bag"></td>
  </tr>
   <tr>
  	<td height="32">&nbsp;</td>
  </tr>
   <tr>
  	<td style="font:20px Arial, Helvetica, sans-serif; color:#3a3a3a;">Name of the product</td>
  </tr>
  <tr>
  	<td height="45">&nbsp;</td>
  </tr> --}}
...
{{-- <table width="190" align="right" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="inner">
  <tr>
    <td><img src="images/bag03.jpg" width="190" height="193" alt="Bag"></td>
  </tr>
   <tr>
  	<td height="32">&nbsp;</td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td><img src="images/bag04.jpg" width="190" height="193" alt="Bag"></td>
  </tr>
   <tr>
  	<td height="32">&nbsp;</td>
  </tr>
