...
@section('content')
    ...
    <livewire:visitor.become-seller />
...
{{--                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">--}}
{{--                                                            <div class="form-group">--}}
{{--                                                                <input onclick="checkValidity('mobile')" id="mobile" name="mobile" placeholder="+273077020163" class="form-control" type="text" placeholder="Mobile *" value="{{ old('mobile') }}">--}}
...
{{--                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">--}}
{{--                                <div class="form-group">--}}
{{--                                    <input onclick="checkValidity('mobile')"  name="mobile" id="telephone" class="form-control" type="tel"  value="{{ old('mobile') }}">--}}
{{--                                    <small class="text-danger error-lablel" id="error-label-mobile"></small>--}}
{{--                                </div>--}}
{{--                            </div>--}}
