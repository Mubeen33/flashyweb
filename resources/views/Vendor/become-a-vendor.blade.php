...
<div class="ps-page--single">
    ...
    <div class="ps-vendor-banner bg--cover" data-background="img/bg/vendor.jpg">
        <div class="container">
            <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="{{ route('frontend.vendor_registration.get') }}">Start Selling</a>
        </div>
    </div>
    ...
    <div class="ps-vendor-banner bg--cover" data-background="img/bg/vendor.jpg">
        <div class="container">
            <h2>It's time to start making money.</h2><a class="ps-btn ps-btn--lg" href="{{ route('frontend.vendor_registration.get') }}">Start Selling</a>
        </div>
    </div>
</div>
