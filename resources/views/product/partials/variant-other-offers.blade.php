@if(count($otherOffers)>0)
        <aside class="widget widget_same-brand">
                    ...
                    @foreach($otherOffers as $otheroffer)    
                        <div class="col-md-12">
                            <h4><b>R {{ $otheroffer->price }}</b><button class="btn btn-warning" id="otherOffer" onclick="addtoCart({{ $otheroffer->prod_id }},{{ $otheroffer->ven_id }},{{ $otheroffer->variation_id }},1,{{ $otheroffer->price }},{{ $otheroffer->id }})">Add to Cart</button></h4>
